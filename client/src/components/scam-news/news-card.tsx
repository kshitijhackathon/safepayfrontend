...
export function ScamNewsCard() {
  ...
  return (
    <Card className="border-none shadow-sm bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-950/50 dark:to-indigo-950/50 bg-white dark:bg-zinc-900/90 transition-colors">
        ...
        {isLoading ? (
          ...
          <div className="space-y-3">
            {news.map((alert, index) => (
              <div key={index}>
                <div 
                  className="cursor-pointer hover:bg-blue-100/50 dark:hover:bg-blue-900/30 p-2 rounded-lg transition-colors bg-white dark:bg-zinc-900/80"
                  onClick={() => handleNewsClick(alert)}
                >
                  <div className="flex justify-between items-start">
                    <div className="flex-1">
                      <h3 className="font-medium text-sm line-clamp-1 text-gray-900 dark:text-gray-100">{alert.title}</h3>
