...
export function NewsDetail({ alert, onClose, onReportSimilar }: NewsDetailProps) {
  ...
  return (
    <Card className="w-full bg-white dark:bg-zinc-900/90 border border-zinc-200 dark:border-zinc-800 shadow-lg transition-colors">
      <CardHeader>
        <div className="flex justify-between items-start mb-2">
          <CardTitle className="text-xl text-gray-900 dark:text-gray-100">{alert.title}</CardTitle>
